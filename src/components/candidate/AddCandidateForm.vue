<template>
  <form class="add-candidate-form" @submit.prevent="submit">
    <!-- THÔNG TIN CƠ BẢN -->
    ...
    <FormSection title="HỌC VẤN">
      <MSInput
        ...
        list="education-levels-add"
      />
      <datalist id="education-levels-add">
...
/* Cap section content width for consistency */
